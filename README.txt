# Exposing a public API for pushing an MPI communicator to the collfs library in ld.so

The following files appear to be involved in exposing a function from libc/libdl:
...
The four currently patched files are:
...
See shaheen/build_glibc_2.4-bgp-10.sh

Launch your executable like this:

/home/aron/bgpsys/lib/ld-2.4.so -args "./main"
